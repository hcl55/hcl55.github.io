...
export const siteConfig: SiteConfig = {
	title: "欢迎大驾光临",
	subtitle: "雪银の小窝",
	siteURL: process.env.SITE || "https://hcl55.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-12-17", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	navbarTitle: {
		...
		icon: "https://hd5.de5.net/profile/1770797790745_favicon.webp",
		// 网站Logo图片路径
	...
	bangumi: {
		userId: "1189287", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "36325121", // 在此处设置你的Bilibili用户ID (vmid)，例如 "1129280784"
	...
	banner: {
		...
		src: {
			desktop: [
				"https://hd5.de5.net/wallpaper/1770718203387_Megumin.webp",
				"https://hd5.de5.net/wallpaper/1770657701854_Elaina.webp",
				"https://hd5.de5.net/wallpaper/1770657752822_Amiya.webp",
			], // 桌面横幅图片
			mobile: [
				"https://hd5.de5.net/wallpaper/1770721005652_Megumin.webp",
				"https://hd5.de5.net/wallpaper/1770727020235_Elaina.webp",
				"https://hd5.de5.net/wallpaper/1770727527659_Amiya.webp",
			], // 移动横幅图片
		}, // 使用本地横幅图片
	...
	favicon: [
		// 留空以使用默认 favicon
		{
		  src: 'https://hd5.de5.net/profile/1770797790745_favicon.webp',    // 图标文件路径
...
export const profileConfig: ProfileConfig = {
	avatar: "https://hd5.de5.net/profile/1770722086409_avatar.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "雪银星月",
	bio: "朝闻道",
	typewriter: {
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoo55.netlify.app/.netlify/functions/twikoo",
		lang: SITE_LANG,
	},
};
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		close: "QWQ 拜了喵~", // 关闭提示
		link: "https://github.com/hcl55/hcl55.github.io", // 关于链接
	},
};
...
export const umamiConfig = {
	...
	apiKey: import.meta.env.PUBLIC_UMAMI_API_KEY, // API密钥优先从环境变量读取，否则使用配置文件中的值
